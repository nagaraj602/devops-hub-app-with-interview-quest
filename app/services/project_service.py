...
class ProjectService:
    ...
    def get_project_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "key_results": [
                "Reduced average time-to-detection for abusive seller activity from days to <strong>under 10 minutes</strong> for high-confidence automated cases.",
                "Cut manual review workload for the trust & safety team by an estimated <strong>60%</strong>.",
                "Reduced fake listing and review manipulation incidents, <strong>improving buyer trust metrics</strong>.",
                "Improved detection pipeline stability during <strong>peak sale events</strong> through better autoscaling and Kafka partition tuning."
            ],
            ...
            "preparation_checklist": [
                {
                    ...
                    "prompt_box": {
                        "header": "Use this response when the interviewer asks variations of:",
                        "questions": [
...
""")
                },
                {
                    ...
                    "prompt_box": {
                        "header": "Use this response when the interviewer asks:",
                        "questions": [
                            "Can you walk me through the key components and architecture of your project?"
                        ]
                    },
                    "content_html": render_md("""
