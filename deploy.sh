...
print_header() {
    ...
    echo -e " Image Target: ${YELLOW}$DEFAULT_IMAGE_NAME:$DEFAULT_TAG ($DEFAULT_VERSION)${RESET}"
    echo -e " Main Port   : ${GREEN}$PORT${RESET} (Ubuntu Base)"
    echo -e " Admin Port  : ${GREEN}$ADMIN_PORT${RESET} (admin.sidorea.shop)"
    echo -e "${CYAN}========================================================================${RESET}\n"
}
...
deploy_docker_compose() {
    ...
    echo -e "   • Admin Portal      : ${CYAN}http://localhost:$ADMIN_PORT${RESET} (or http://localhost:$PORT/admin)"
...
deploy_docker_desktop_k8s() {
    ...
    echo -e "   • Admin Portal      : ${CYAN}http://localhost:$ADMIN_PORT${RESET} (or http://localhost:$PORT/admin)"
    echo -e "   • NodePort Main     : ${CYAN}http://localhost:30926${RESET}"
    echo -e "   • NodePort Admin    : ${CYAN}http://localhost:30956${RESET}"
    echo -e "   • Question Bank     : ${CYAN}http://localhost:$PORT/question-bank${RESET}"
    echo -e "   • Project Page      : ${CYAN}http://localhost:$PORT/project${RESET}"
    echo -e "   • Training Materials: ${CYAN}http://localhost:$PORT/training-materials${RESET}"
    echo -e "   • Command Cheatsheet: ${CYAN}http://localhost:$PORT/command-cheatsheet${RESET}"
